...
/**
  ...
  */
final case class Get[Input0 <: Batch](operand0: NeuralNetwork.Aux[Input0, Seq2D#ConcreteBatch], i: Int, j: Int)
    extends NeuralNetwork { this: NeuralNetwork.Aux[Input0, Batch.Aux[Eval[scala.Double], Eval[scala.Double]]] =>
